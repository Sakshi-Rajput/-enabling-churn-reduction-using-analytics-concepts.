rm(list = ls())
setwd("C:/Users/kumrovz/Downloads/Edwisor/project/Churn")
# #loading Libraries
...
#Entire Comparison
write.csv(test_Original,'C:/Users/kumrovz/Downloads/Edwisor/project/Data/R_output/Full_output.csv',row.names = F)
...
write.csv(submit,file = 'C:/Users/kumrovz/Downloads/Edwisor/project/Data/R_output/Final_Churn_Class_Probab.csv',row.names = F)
rm(list = ls())